...
using BeerTapExercise2.ApiServices;
using BeerTapExercise2.ApiServices.Security;
using BeerTapExercise2.Documentation.Installers;
using BeerTapExercise2.WebApi.Handlers;
using BeerTapExercise2.WebApi.Hypermedia;
using BeerTapExercise2.WebApi.Infrastructure.Installers;
using BeerTapExercise2.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;

namespace BeerTapExercise2.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
        ...
        {
            return
                _windsorContainer.Resolve<ApiSecurityContextProvidingHandler<BeerTapExercise2ApiUser, NullUserContext>>();
        }
